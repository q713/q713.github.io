    ...
    return (
        <div className="max-w-4xl mx-auto px-10 flex flex-col divide-y">
            <div className="flex py-10 flex-col pb-20 text-left gap-4">
                ...
                <p>I'm generally interest in Operating-, Database- and generally Distributed-Systems. I am particularly interested 
                ...
                <p>Below you can see some of my projects as well as links to Columbo SimBricks.</p>
                <p>You can also find me at my <a className="font-bold" href="https://github.com/q713">GitHub</a> account.</p>
            </div>
            ...
            <div className="flex py-10 pb-20 flex-col items-start space-y-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-2">
                    ...
                    <div onClick={() => redirect("https://simbricks.github.io/")} className=" bg-white/20 p-6 rounded-md shadow-md cursor-pointer border-2 border-gray-50 hover:border-black hover:border-2 transition-colors duration-300">
                      ...
                      <p className="text-gray-700">SimBricks is a modular full-system end-to-end simulation framework.
                                Within the context of SimBricks im currently writing my Masters-Thesis.</p>
                      <div className="flex flex-col justify-center items-center">
                    ...
                    <div onClick={() => redirect("https://simbricks.github.io/projects/columbo.html")} className=" bg-white/20 p-6 rounded-md shadow-md cursor-pointer border-2 border-gray-50 hover:border-black hover:border-2 transition-colors duration-300">
                      ...
                      <p className="text-gray-700 mb-4">Columbo adds library support to SimBricks allowing to create Low-Level End-to-End System-Traces through SimBricks Simulation.</p>
